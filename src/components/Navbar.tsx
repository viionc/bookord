...
import {getColorByUserRole} from "../utilities/utilities";

export default function Navbar() {
    const {handleModalReducer} = useModalsContext();
    const {currentUser, logoutUser, loginAnonymously, currentUserProfile} = useFirebaseContext();
            ...
            <NavbarBs className="bg-dark shadow-lg text-white p-1 fs-3 px-5">
                ...
                {!currentUserProfile ? (
                    ...
                    <div className="d-flex justify-content-center align-items-center gap-2">
                        ...
                        <Button
                            id="settings-button"
                            className={`bg-dark me-2 lg `}
                            style={{width: 48}}
                            onClick={() => handleModalReducer({type: "USER_SETTINGS"})}
                        >
                            <svg
